...
### Модуль reader_csv_excel:
Содержит 2 новые функции:
1. Из .csv файла считывает транзакции и возвращает их ввиде списка
2. Из excel файлов считывает транзакции и возвращает список словарей